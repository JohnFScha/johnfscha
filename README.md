...
Full-stack developer based in Argentina 🇦🇷, passionate about building modern web applications and exploring new technologies. When I'm not coding, you'll find me deep into manga, anime, or playing JRPGs like the Final Fantasy series.
...
### 🎯 Recent Work (2025)
- **[Improving Technical Test](https://github.com/JohnFScha/improving-technical-test)** - TypeScript-based technical assessment project
- **[Normas Teaching Test](https://github.com/JohnFScha/normas-teaching-technical-test)** - Educational platform technical implementation with TypeScript
- **[NestJS API Test](https://github.com/JohnFScha/nestjs-api-test)** - RESTful API built with NestJS framework
- **[Go Pocket](https://github.com/JohnFScha/go-pocket)** - Learning Go through practical project development

### 🎮 Fun Projects
- **[Who's that pokemon?!](https://github.com/JohnFScha/adivinar-pokemon-v2)** - React-based Pokémon guessing game for nerdy know-it-alls
- **[Pokémon Search](https://github.com/JohnFScha/poke-search)** - Interactive Pokémon search application
- **[Vue Test App](https://github.com/JohnFScha/vue-test)** - Experimental Vue.js application
...
- **[OneClickEnglish](https://github.com/JohnFScha/OneClickEnglish)** - Landing page for an international English academy
- **[Bookstore App](https://github.com/JohnFScha/bookstore-app-v2)** - Full-stack CRUD application with MongoDB
...
- 🗳️ **Politics** - Always eager to discuss political systems and theories
- 🧠 **Psychology** - Fascinated by human behavior and cognitive science
- 📚 **Manga & Anime** - From classics to new releases
- 🎮 **JRPGs** - Final Fantasy series enthusiast
